            ...
            <div className="container mx-auto px-4 sm:px-6 lg:px-8">
                <div className="flex items-center justify-between h-16">
                    ...
                    <Link href="/" className="flex items-center gap-3">
                        <Image src="/logo.png" alt="Innovate & Amplify Logo" width={40} height={40} className="w-10 h-10" />
                    ...
                    <div className="md:hidden py-4 space-y-4">
                        {navLinks.map((link) => (
                            <Link
                                ...
                                href={link.href}
                                className={cn(
                                    "block text-sm font-medium transition-colors hover:text-primary px-2 py-1",
